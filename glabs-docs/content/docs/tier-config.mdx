...
description: Understanding Free, Pro and Ultra tier differences
---
...
```typescript
import { getVideoAspectRatioEnum } from '@getvrex/glabs-sdk';
...
```typescript
import { getImageAspectRatioEnum } from '@getvrex/glabs-sdk';
